...
import { Side, WaveProps } from "../interfaces";
...
const Wave: React.FC<WaveProps> = ({ children, position: { x, y }, side, isTransitioning }) => {
  ...
  const animatedProps = useAnimatedProps(() => {
    ...
    // 0.5522847498 is taken from the beizer curve theorm gotten from here: https://spencermortensen.com/articles/bezier-circle/
  ...
  // Fixing performance issues on different os for the js threading
